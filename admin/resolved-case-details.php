<?php
	...
	if (isset($_GET["id"]))
		$_SESSION["resolution-id"] = $_GET["id"];
	else {
...
<body>
	...
	<main id="resolved-case-details">
		<a href="archive.php"><i class="fas fa-arrow-circle-left"></i>Back to Archive</a>
		<hr />
		<section>
			<h2>Resolved Case Report</h2>
			<table id="resolved-case-details-tbl">
				<?php require_once "src/view-resolved-case-details.php"; ?>
			</table>
		</section>
	</main>
</body>
